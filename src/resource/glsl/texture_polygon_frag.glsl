...
{
    // Material properties
    vec3 texture_diffuse_color = texture( texture2D, vertex_UV ).rgb;
    vec3 ambient_diffuse_color = ambientColor * texture_diffuse_color;
    ...
    color =
            ...
            texture_diffuse_color * lightColor * lightPower * cosTheta / (distance*distance) +
