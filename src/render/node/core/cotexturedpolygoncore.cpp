...
void CoTexturedPolygonCore::paint()
{
    ...
    glBindBuffer(GL_ARRAY_BUFFER, m_pTextureBufferObject->getID());
...
void CoTexturedPolygonCore::createShaderProgram()
{
    ...
    m_pShaderProgram->AddShaders(EShaderType::eFragment, ":resource/glsl/texture_polygon_frag.glsl");
//    m_pShaderProgram->AddShaders(EShaderType::eGeometry, ":resource/glsl/texture_polygon_geom.glsl");
    m_pShaderProgram->AddShaders(EShaderType::eVertex, ":resource/glsl/texture_polygon_vert.glsl");
...
void CoTexturedPolygonCore::bindObject()
{
    ...
    glTexImage2D(GL_TEXTURE_2D,
                 0,
                 GL_RGBA,
                 pPolygon->getTextureWidth(),
                 pPolygon->getTextureHeight(),
                 0,
                 GL_BGRA,
                 GL_UNSIGNED_BYTE,
                 pPolygon->getTextureData());
